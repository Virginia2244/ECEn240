...
int SensedLightRight = 0;
int SensedLightLeft = 0;
int SensedLightUp = 0;
int SensedLightDown = 0;
...
int ActionCollision = 0;

// Main motors Action (using Definitions)
int ActionRobotDrive = 0;
...
//tau of capacitive sensor
long CapacitorTouched = 0;
